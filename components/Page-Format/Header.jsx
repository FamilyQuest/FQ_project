  ...
  return (
    <View>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.headerLogo} onPress={() => Linking.openURL('https://github.com/FamilyQuest/FQ_project') }>
          <Image style={styles.headerLogoImg} source={require('../../assets/General/Logo.png')} />
        </TouchableOpacity>
      </View>
      <Modal
        animationType="slide"
